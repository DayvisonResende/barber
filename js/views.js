                ...
                <div class="space-y-6 fade-in pb-6">
                    ...
                    <div class="card-bg rounded-2xl border border-theme p-6 space-y-5 shadow-xl">
                        ...
                        <div class="space-y-4 pt-2 border-t border-theme/50">
                            <div class="bg-amber-500/5 border border-amber-500/10 p-4 rounded-xl space-y-3">
                                <label class="text-[10px] text-amber-500 uppercase font-black tracking-widest">Repasse ao Barbeiro (%)</label>
                                <div class="relative">
                                    <input type="number" id="shop-commission" value="${s.commission_rate || 100}" min="0" max="100" class="w-full input-bg border border-zinc-700/50 rounded-xl p-3 text-theme focus:border-amber-500 outline-none transition-colors font-bold" />
                                    <div class="absolute right-4 top-1/2 -translate-y-1/2 text-muted-theme font-black">%</div>
                                </div>
                                <p class="text-[9px] text-muted-theme italic leading-relaxed">Define quanto do valor total o barbeiro recebe. Ex: 90% significa que a casa fica com 10%.</p>
                            </div>
