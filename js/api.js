    ...
    async completeAppointment() {
        ...
        if (apt) {
            ...
            const { error: txError } = await supabaseClient.from('transactions').insert({
                ...
                barber_name: apt.barberName // Nome amigável para o Admin
            });
