...
const dailyTableMethod = `
    ...
    const injectDailyTableIdx = content.indexOf('    renderAgendamentos() {');
    content = content.substring(0, injectDailyTableIdx) + dailyTableMethod + '\n\n' + content.substring(injectDailyTableIdx);
    ...
    const toggleHtml = `                        <div class="flex justify-between items-center">
